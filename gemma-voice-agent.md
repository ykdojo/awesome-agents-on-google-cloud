...
The model at this point was a hosted Gemini model: good for quick testing while the rest of the system took shape. ([Full file.](gemma-voice-agent-code/app/model.py))
